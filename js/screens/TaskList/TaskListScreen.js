		...
		<SafeAreaView style={commonStyles.container}>
			<View style={{flex:1}}>
				...
				<View style={commonStyles.pageContainer}>
					<FlatList
						ListHeaderComponent={<BtnDisplay onPress={() =>
						...
						renderItem={
							displayType == "appointments" ? renderItemPresent : renderItemQuotes
						}
						keyExtractor={(item) => item.id.toString()}
					/>
				</View>
			</View>
			<BottomNav style={{flex:0.1}} navigation={navigation} routeProps={route} activated="Home" />
		</SafeAreaView>
	);
};
